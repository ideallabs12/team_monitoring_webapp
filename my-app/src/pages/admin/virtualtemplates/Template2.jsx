...
<table role="presentation" width="100%" height="100%" cellpadding="0" cellspacing="0" style="background-color:${t.bgCard}; width:100%; height:100%;">
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 14px 0;">
              <tr>
                <td style="background-color:${t.accentText}; border-radius:16px; padding:4px 14px;">
                  <p style="margin:0; font-size:11px; font-weight:bold; letter-spacing:2.5px; color:${t.accent}; font-family: Arial, sans-serif;">${fields.companyName.split('').join(' ').toUpperCase()}</p>
                </td>
              </tr>
            </table>
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="33.33%" valign="top" align="center" style="padding: 0 12px; position:relative;">
            ...
            <div style="width:36px; height:36px; border-radius:50%; background-color:${t.accent}; color:${t.accentText}; text-align:center; line-height:36px; font-size:15px; font-weight:bold; font-family: Arial, sans-serif; margin: 0 auto 12px auto; position: relative; z-index: 2;">1</div>
          ...
          <td width="33.33%" valign="top" align="center" style="padding: 0 12px; position:relative;">
            <div style="position:absolute; top: 17px; left: 50%; width: 100%; height: 2px; background-color: ${t.borderMuted}; z-index: 1;"></div>
            <div style="width:36px; height:36px; border-radius:50%; background-color:${t.accent}; color:${t.accentText}; text-align:center; line-height:36px; font-size:15px; font-weight:bold; font-family: Arial, sans-serif; margin: 0 auto 12px auto; position: relative; z-index: 2;">2</div>
            <p style="margin:0 0 6px 0; font-size:16px; font-weight:bold; color:${t.textPrimary}; font-family: Arial, sans-serif;">Tag Us</p>
            <p style="margin:0; font-size:13.5px; line-height:1.4; color:${t.textSecondary}; font-family: Arial, sans-serif;">Make sure to tag ${fields.linkedinHandle} in your post.</p>
          </td>

          <!-- Step 3 (No outgoing line) -->
          <td width="33.33%" valign="top" align="center" style="padding: 0 12px; position:relative;">
            <div style="width:36px; height:36px; border-radius:50%; background-color:${t.accent}; color:${t.accentText}; text-align:center; line-height:36px; font-size:15px; font-weight:bold; font-family: Arial, sans-serif; margin: 0 auto 12px auto; position: relative; z-index: 2;">3</div>
  ...
  <tr>
    <td style="padding:28px 40px 30px 40px; border-top:1px solid ${t.borderMuted};">
      ...
      <p style="margin:0; font-size:14px; color:${t.textSecondary}; font-family: Arial, sans-serif;">${fields.companyName}</p>
    </td>
  </tr>
  ...
  <tr>
    <td style="background-color:${t.accent}; padding:12px; text-align:center;">
      <p style="margin:0; font-size:13px; letter-spacing:1px; font-weight:bold; color:${t.accentText}; font-family: Arial, sans-serif;">${fields.websiteUrl}</p>
    </td>
  </tr>
...
/* ════════════════════════════════════════════════════════════
   ...
   ════════════════════════════════════════════════════════════ */
const FIELD_CONFIG = [
  { key: 'companyName', label: 'Company / Org Name', icon: Building2, placeholder: 'e.g. WYN Conferences', wide: false },
  ...
  { key: 'linkedinHandle', label: 'LinkedIn Handle', icon: Tag, placeholder: '@WynConferences', wide: false },
  { key: 'linkedinUrl', label: 'LinkedIn URL (For PDF Button)', icon: FileText, placeholder: 'https://...', wide: true },
    ...
    try {
      ...
      try {
        ...
        if (btn && saved.linkedinUrl) {
          ...
          pdf.link(linkX, linkY, linkW, linkH, { url: saved.linkedinUrl })
        }
