            ...
            <div style={{ borderBottom: '1px solid var(--apple-border)', paddingBottom: '10px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                {viewingProfileUser.phone && (
                  <a 
                    href={`https://wa.me/${viewingProfileUser.phone.replace(/\D/g, '').length === 10 ? '91' + viewingProfileUser.phone.replace(/\D/g, '') : viewingProfileUser.phone.replace(/\D/g, '')}`} 
                    target="_blank" 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'rgba(255,255,255,0.02)', padding: '12px 16px', borderRadius: '12px', border: '1px solid var(--apple-border)' }}>
                  ...
                  <button
                    ...
                    disabled={saving}
                    style={{ position: 'relative', display: 'inline-block', width: '40px', minWidth: '40px', height: '24px', minHeight: '24px', borderRadius: '14px', padding: 0, background: viewingProfileUser.exclude_from_analytics  ? 'var(--apple-accent-blue)' : 'rgba(150, 150, 150, 0.25)', border: '1px solid rgba(255, 255, 255, 0.05)', cursor: 'pointer', transition: 'background 150ms ease', flexShrink: 0 }}
                  >
                    <div style={{ width: '22px', height: '22px', borderRadius: '50%', background: '#ffffff', boxShadow: '0 2px 4px rgba(0,0,0,0.2)', position: 'absolute', top: '50%', transform: 'translateY(-50%)', left: viewingProfileUser.exclude_from_analytics  ? '16px' : '0px', transition: 'left 150ms ease' }} />
                  </button>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'rgba(255,255,255,0.02)', padding: '12px 16px', borderRadius: '12px', border: '1px solid var(--apple-border)' }}>
