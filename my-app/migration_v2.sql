-- =========================================================================
-- MIGRATION SCRIPT v2
-- Run this in your Supabase SQL Editor to support per-team permissions.
-- =========================================================================
...
SET team_settings = (
  WITH user_teams AS (
    ...
    UNION ALL
    SELECT (key)::uuid as tid, value#>>'{}' as r
...
-- Step 4: Drop old columns (Optional, but recommended once you verify everything works!)
